...
func newFullAgent() *Agent {
	return &Agent{
		TypeMeta:   metav1.TypeMeta{Kind: "Agent", APIVersion: "kaalm.io/v1beta1"},
...
func TestAgentListDeepCopy(t *testing.T) {
	list := &AgentList{
		TypeMeta: metav1.TypeMeta{Kind: "AgentList", APIVersion: "kaalm.io/v1beta1"},
...
func newFullAgentChannel() *AgentChannel {
	return &AgentChannel{
		TypeMeta:   metav1.TypeMeta{Kind: "AgentChannel", APIVersion: "kaalm.io/v1beta1"},
...
func TestAgentChannelListDeepCopy(t *testing.T) {
	list := &AgentChannelList{
		TypeMeta: metav1.TypeMeta{Kind: "AgentChannelList", APIVersion: "kaalm.io/v1beta1"},
		ListMeta: metav1.ListMeta{ResourceVersion: "1"},
...
func newFullAgentClass() *AgentClass {
	return &AgentClass{
		TypeMeta:   metav1.TypeMeta{Kind: "AgentClass", APIVersion: "kaalm.io/v1beta1"},
...
func TestAgentClassListDeepCopy(t *testing.T) {
	list := &AgentClassList{
		TypeMeta: metav1.TypeMeta{Kind: "AgentClassList", APIVersion: "kaalm.io/v1beta1"},
		ListMeta: metav1.ListMeta{ResourceVersion: "1"},
...
func newFullAgentTask() *AgentTask {
	return &AgentTask{
		TypeMeta:   metav1.TypeMeta{Kind: "AgentTask", APIVersion: "kaalm.io/v1beta1"},
...
func TestAgentTaskListDeepCopy(t *testing.T) {
	list := &AgentTaskList{
		TypeMeta: metav1.TypeMeta{Kind: "AgentTaskList", APIVersion: "kaalm.io/v1beta1"},
		ListMeta: metav1.ListMeta{ResourceVersion: "1"},
...
func newFullModelProvider() *ModelProvider {
	return &ModelProvider{
		TypeMeta:   metav1.TypeMeta{Kind: "ModelProvider", APIVersion: "kaalm.io/v1beta1"},
...
func TestModelProviderListDeepCopy(t *testing.T) {
	list := &ModelProviderList{
		TypeMeta: metav1.TypeMeta{Kind: "ModelProviderList", APIVersion: "kaalm.io/v1beta1"},
		ListMeta: metav1.ListMeta{ResourceVersion: "1"},
...
func newFullToolProvider() *ToolProvider {
	return &ToolProvider{
		TypeMeta:   metav1.TypeMeta{Kind: "ToolProvider", APIVersion: "kaalm.io/v1beta1"},
...
func TestToolProviderListDeepCopy(t *testing.T) {
	list := &ToolProviderList{
		TypeMeta: metav1.TypeMeta{Kind: "ToolProviderList", APIVersion: "kaalm.io/v1beta1"},
		ListMeta: metav1.ListMeta{ResourceVersion: "1"},
...
func TestGroupVersion(t *testing.T) {
	...
	if GroupVersion.Version != "v1beta1" {
		t.Fatalf("GroupVersion.Version = %q, want v1beta1", GroupVersion.Version)
	}
	if AddToScheme == nil {
