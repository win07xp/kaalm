...
After an agent becomes something other people talk to, a pile of unglamorous
...
- **What does it cost while nobody is using it?** An agent that is idle at 3 AM
...
- code you wrote, running inside it without a build,
