...
| 504 | `provider_timeout` | no | Upstream provider timed out after exhausting fallback chain. Same rationale as `provider_error` — fallback chain already burned |
