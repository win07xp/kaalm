...
func mkOpenTP(t *testing.T, name string, mutate func(*kaalmv1alpha1.ToolProvider)) {
	t.Helper()
	mkToolProvider(t, name, func(tp *kaalmv1alpha1.ToolProvider) {
...
func grantOf(name string, tools ...string) kaalmv1alpha1.AgentToolGrant {
	return kaalmv1alpha1.AgentToolGrant{
		ProviderRef: kaalmv1alpha1.LocalObjectReference{Name: name},
		Tools:       tools,
	}
}
...
func TestAgentToolGrant_ClassAllowlistGateAndRecovery(t *testing.T) {
	...
	mkWorkloadAgent(t, "r37-agent", "wc-r37", func(ag *kaalmv1alpha1.Agent) {
		ag.Spec.Tools = []kaalmv1alpha1.AgentToolGrant{grantOf("tg-r37")}
	})
	expectAgentPhase(t, "r37-agent", kaalmv1alpha1.AgentDegraded)
	expectAgentReadyReason(t, "r37-agent", kaalmv1alpha1.ReasonClassConstraintViolation)
	...
	eventually(t, func() error {
		...
		ac.Spec.AllowedToolProviders = []kaalmv1alpha1.LocalObjectReference{{Name: "tg-r37"}}
...
func TestAgentToolGrant_MissingProviderGateAndRecovery(t *testing.T) {
	mkWorkloadClass(t, "wc-r35", func(ac *kaalmv1alpha1.AgentClass) {
		ac.Spec.AllowedToolProviders = []kaalmv1alpha1.LocalObjectReference{{Name: "tg-r35"}}
	})
	mkWorkloadAgent(t, "r35-agent", "wc-r35", func(ag *kaalmv1alpha1.Agent) {
		ag.Spec.Tools = []kaalmv1alpha1.AgentToolGrant{grantOf("tg-r35")}
	})
	expectAgentPhase(t, "r35-agent", kaalmv1alpha1.AgentDegraded)
	expectAgentReadyReason(t, "r35-agent", kaalmv1alpha1.ReasonClassConstraintViolation)
...
func TestAgentToolGrant_NamespaceDeniedGateAndRecovery(t *testing.T) {
	mkToolProvider(t, "tg-r36", func(tp *kaalmv1alpha1.ToolProvider) {
		tp.Spec.CredentialsRef = nil
		tp.Spec.AllowedNamespaces = []string{"team-*"} // agent lives in default
	})
	mkWorkloadClass(t, "wc-r36", func(ac *kaalmv1alpha1.AgentClass) {
		ac.Spec.AllowedToolProviders = []kaalmv1alpha1.LocalObjectReference{{Name: "tg-r36"}}
	})
	mkWorkloadAgent(t, "r36-agent", "wc-r36", func(ag *kaalmv1alpha1.Agent) {
		ag.Spec.Tools = []kaalmv1alpha1.AgentToolGrant{grantOf("tg-r36")}
	})
	expectAgentPhase(t, "r36-agent", kaalmv1alpha1.AgentDegraded)
	expectAgentReadyReason(t, "r36-agent", kaalmv1alpha1.ReasonClassConstraintViolation)
...
func TestAgentToolGrant_EmptyAllowedNamespacesDeniesAll(t *testing.T) {
	...
	mkToolProvider(t, "tg-empty", func(tp *kaalmv1alpha1.ToolProvider) {
		tp.Spec.CredentialsRef = nil
		tp.Spec.AllowedNamespaces = nil
	})
	mkWorkloadClass(t, "wc-empty", func(ac *kaalmv1alpha1.AgentClass) {
		ac.Spec.AllowedToolProviders = []kaalmv1alpha1.LocalObjectReference{{Name: "tg-empty"}}
	})
	mkWorkloadAgent(t, "empty-agent", "wc-empty", func(ag *kaalmv1alpha1.Agent) {
		ag.Spec.Tools = []kaalmv1alpha1.AgentToolGrant{grantOf("tg-empty")}
	})
	expectAgentPhase(t, "empty-agent", kaalmv1alpha1.AgentDegraded)
...
func TestAgentToolGrant_CatalogGateAndRecovery(t *testing.T) {
	mkOpenTP(t, "tg-r38", func(tp *kaalmv1alpha1.ToolProvider) {
		tp.Spec.Tools = []kaalmv1alpha1.ToolProviderTool{{ID: "web_search"}}
	})
	mkWorkloadClass(t, "wc-r38", func(ac *kaalmv1alpha1.AgentClass) {
		ac.Spec.AllowedToolProviders = []kaalmv1alpha1.LocalObjectReference{{Name: "tg-r38"}}
	})
	mkWorkloadAgent(t, "r38-agent", "wc-r38", func(ag *kaalmv1alpha1.Agent) {
		ag.Spec.Tools = []kaalmv1alpha1.AgentToolGrant{grantOf("tg-r38", "fetch_page")}
	})
	expectAgentPhase(t, "r38-agent", kaalmv1alpha1.AgentDegraded)
	expectAgentReadyReason(t, "r38-agent", kaalmv1alpha1.ReasonToolNotInCatalog)
	...
	eventually(t, func() error {
		...
		tp.Spec.Tools = append(tp.Spec.Tools, kaalmv1alpha1.ToolProviderTool{ID: "fetch_page"})
		return testClient.Update(ctxT(), &tp)
	})
...
func TestAgentToolGrant_NoCatalogAcceptsAnyNarrowing(t *testing.T) {
	...
	mkWorkloadClass(t, "wc-nocat", func(ac *kaalmv1alpha1.AgentClass) {
		ac.Spec.AllowedToolProviders = []kaalmv1alpha1.LocalObjectReference{{Name: "tg-nocat"}}
	})
	mkWorkloadAgent(t, "nocat-agent", "wc-nocat", func(ag *kaalmv1alpha1.Agent) {
		ag.Spec.Tools = []kaalmv1alpha1.AgentToolGrant{grantOf("tg-nocat", "anything-goes")}
	})
...
func TestTaskToolGrant_ViolationIsTerminalFailed(t *testing.T) {
	...
	mkTask(t, "t-tool", "tc-tool", func(task *kaalmv1alpha1.AgentTask) {
		task.Spec.Tools = []kaalmv1alpha1.AgentToolGrant{grantOf("tg-task")}
	})
	expectTaskPhase(t, "t-tool", kaalmv1alpha1.TaskFailed)
	c := condition(getTask(t, "t-tool").Status.Conditions, kaalmv1alpha1.ConditionCompleted)
...
func TestTaskToolGrant_ValidGrantProvisions(t *testing.T) {
	...
	mkWorkloadClass(t, "tc-tool-ok", func(ac *kaalmv1alpha1.AgentClass) {
		ac.Spec.AllowedToolProviders = []kaalmv1alpha1.LocalObjectReference{{Name: "tg-task-ok"}}
	})
	mkTask(t, "t-tool-ok", "tc-tool-ok", func(task *kaalmv1alpha1.AgentTask) {
		task.Spec.Tools = []kaalmv1alpha1.AgentToolGrant{grantOf("tg-task-ok")}
	})
	eventually(t, func() error {
		...
		case kaalmv1alpha1.TaskFailed:
			return errString("task failed on a valid grant")
		case "", kaalmv1alpha1.TaskPending:
			return errString("no phase yet")
		}
		return nil
	})
...
func TestAgentClass_MissingToolProviderIsNotReadyAndRecovers(t *testing.T) {
	ac := &kaalmv1alpha1.AgentClass{
		...
		Spec: kaalmv1alpha1.AgentClassSpec{
			AllowedToolProviders: []kaalmv1alpha1.LocalObjectReference{{Name: "tg-cls"}},
		},
	}
	...
	expectReady(t, get, metav1.ConditionFalse, kaalmv1alpha1.ReasonInvalidReference)

	// Creating the ToolProvider recovers the class through its watch.
	mkOpenTP(t, "tg-cls", nil)
	expectReady(t, get, metav1.ConditionTrue, kaalmv1alpha1.ReasonAllReferencesResolved)
}
