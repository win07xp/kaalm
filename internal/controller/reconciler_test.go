...
func mkProvider(t *testing.T, name string, mutate func(*kaalmv1beta1.ModelProvider)) {
	t.Helper()
...
func mkClass(t *testing.T, name string, allowed ...string) {
	t.Helper()
	ac := &kaalmv1beta1.AgentClass{ObjectMeta: metav1.ObjectMeta{Name: name}}
	for _, p := range allowed {
		ac.Spec.AllowedProviders = append(ac.Spec.AllowedProviders, kaalmv1beta1.LocalObjectReference{Name: p})
	}
...
func mkAgent(t *testing.T, name, className string, providers ...string) {
	...
	ag := &kaalmv1beta1.Agent{
		...
		Spec:       kaalmv1beta1.AgentSpec{AgentClassRef: kaalmv1beta1.LocalObjectReference{Name: className}},
	}
...
func TestAgentClass_InvalidCIDRIsNotReady(t *testing.T) {
	ac := &kaalmv1beta1.AgentClass{ObjectMeta: metav1.ObjectMeta{Name: "ac-badcidr"}}
...
func TestModelProvider_CredentialsMissingIsNotReady(t *testing.T) {
	mkProvider(t, "mp-nocred", func(mp *kaalmv1beta1.ModelProvider) {
		mp.Spec.CredentialsRef = kaalmv1beta1.SecretKeyReference{Name: "absent-secret", Key: "token"}
	})
	expectReady(t, func() []metav1.Condition {
...
func TestModelProvider_ValidBecomesReadyAndHealthy(t *testing.T) {
	...
	mkProvider(t, "mp-ok", func(mp *kaalmv1beta1.ModelProvider) {
...
func TestModelProvider_AuthFailedIsNotReady(t *testing.T) {
	...
	mkProvider(t, "mp-auth", func(mp *kaalmv1beta1.ModelProvider) {
		mp.Spec.HealthCheck = &kaalmv1beta1.ModelProviderHealthCheck{Enabled: true}
	})
	expectReady(t, func() []metav1.Condition {
		var mp kaalmv1beta1.ModelProvider
...
func TestModelProvider_HealthCheckDisabledSkipsProbe(t *testing.T) {
	...
	mkProvider(t, "mp-nohc", func(mp *kaalmv1beta1.ModelProvider) {
...
func TestModelProvider_InvalidDegradeTargetIsNotReady(t *testing.T) {
	...
	mkProvider(t, "mp-deg", func(mp *kaalmv1beta1.ModelProvider) {
		to := "no-such-model"
		mp.Spec.Models = []kaalmv1beta1.ModelProviderModel{{ID: "real-model"}}
...
func TestModelProviderIsReferenced_ByAgentAndTask(t *testing.T) {
	...
	mkTask(t, "iref-task", "iref-tcls", func(task *kaalmv1beta1.AgentTask) {
		task.Spec.Providers = []kaalmv1beta1.AgentProviderReference{
			{ProviderRef: kaalmv1beta1.LocalObjectReference{Name: "iref-task-prov"}},
		}
	})
	eventually(t, func() error {
...
func TestModelProvider_CredentialKeyMissing(t *testing.T) {
	...
	mkProvider(t, "mp-wrongkey", func(mp *kaalmv1beta1.ModelProvider) {
		mp.Spec.CredentialsRef = kaalmv1beta1.SecretKeyReference{Name: "mp-wrongkey-secret", Key: "token"}
	})
	expectReady(t, func() []metav1.Condition {
		var mp kaalmv1beta1.ModelProvider
...
func TestModelProvider_DeleteHeldWhileReferenced(t *testing.T) {
	...
	mkProvider(t, "mpref", func(mp *kaalmv1beta1.ModelProvider) {
		mp.Spec.CredentialsRef = kaalmv1beta1.SecretKeyReference{Name: "mpref-key", Key: "token"}
	})
	expectReady(t, func() []metav1.Condition {
		var mp kaalmv1beta1.ModelProvider
...
func TestModelProvider_ProbeErrStaysReady(t *testing.T) {
	...
	mkProvider(t, "mp-unhealthy", func(mp *kaalmv1beta1.ModelProvider) {
		mp.Spec.CredentialsRef = kaalmv1beta1.SecretKeyReference{Name: "mp-unhealthy-key", Key: "token"}
		// IntervalSeconds>0 exercises the interval() configured branch.
		mp.Spec.HealthCheck = &kaalmv1beta1.ModelProviderHealthCheck{Enabled: true, IntervalSeconds: 5}
	})
	get := func() []metav1.Condition {
		var mp kaalmv1beta1.ModelProvider
...
func TestAgentClass_AllowedHostsUnsupportedByCNI(t *testing.T) {
	ac := &kaalmv1beta1.AgentClass{ObjectMeta: metav1.ObjectMeta{Name: "ac-hosts"}}
	...
	eventually(t, func() error {
		...
		if c == nil || c.Status != metav1.ConditionFalse ||
			c.Reason != kaalmv1beta1.ReasonFQDNPolicyUnsupported {
...
func TestAgentClass_InvalidHostIsNotReady(t *testing.T) {
	ac := &kaalmv1beta1.AgentClass{ObjectMeta: metav1.ObjectMeta{Name: "ac-badhost"}}
...
func TestGetErrorBranches(t *testing.T) {
	...
	mp := &kaalmv1beta1.ModelProvider{
		...
		Spec:       kaalmv1beta1.ModelProviderSpec{CredentialsRef: kaalmv1beta1.SecretKeyReference{Name: "s", Key: "token"}},
	}
	_, reason, msg := r.credential(ctx, mp)
	if reason != kaalmv1beta1.ReasonCredentialsMissing || msg == "" {
		t.Errorf("credential Get error: reason=%q msg=%q", reason, msg)
	}

	// reconcileBudget surfaces a non-NotFound ConfigMap Get error.
	budgeted := &kaalmv1beta1.ModelProvider{
		ObjectMeta: metav1.ObjectMeta{Name: "b"},
		Spec:       kaalmv1beta1.ModelProviderSpec{Budget: kaalmv1beta1.ModelProviderBudget{Period: "monthly"}},
	}
...
func TestMapFuncs_ListErrorReturnsNil(t *testing.T) {
	...
	if reqs := ar.agentsForClass(ctx, &kaalmv1beta1.AgentClass{ObjectMeta: metav1.ObjectMeta{Name: "c"}}); reqs != nil {
		t.Errorf("agentsForClass on a list error must return nil: %v", reqs)
	}
	if reqs := ar.agentsForProvider(ctx, &kaalmv1beta1.ModelProvider{ObjectMeta: metav1.ObjectMeta{Name: "p"}}); reqs != nil {
		t.Errorf("agentsForProvider on a list error must return nil: %v", reqs)
	}

	acr := &AgentClassReconciler{Client: c}
	if reqs := acr.classesForProvider(ctx, &kaalmv1beta1.ModelProvider{ObjectMeta: metav1.ObjectMeta{Name: "p"}}); reqs != nil {
		t.Errorf("classesForProvider on a list error must return nil: %v", reqs)
	}

	tr := &AgentTaskReconciler{Client: c}
	if reqs := tr.tasksForClass(ctx, &kaalmv1beta1.AgentClass{ObjectMeta: metav1.ObjectMeta{Name: "c"}}); reqs != nil {
		t.Errorf("tasksForClass on a list error must return nil: %v", reqs)
	}

	chr := &AgentChannelReconciler{Client: c}
	if reqs := chr.channelsForAgent(ctx, &kaalmv1beta1.Agent{ObjectMeta: metav1.ObjectMeta{Name: "a", Namespace: "default"}}); reqs != nil {
...
func TestClassForWorkload(t *testing.T) {
	...
	ag := &kaalmv1beta1.Agent{
		...
		Spec:       kaalmv1beta1.AgentSpec{AgentClassRef: kaalmv1beta1.LocalObjectReference{Name: "cls"}},
	}
	...
	task := &kaalmv1beta1.AgentTask{
		...
		Spec:       kaalmv1beta1.AgentTaskSpec{AgentClassRef: kaalmv1beta1.LocalObjectReference{Name: "tcls"}},
	}
	...
	empty := &kaalmv1beta1.Agent{ObjectMeta: metav1.ObjectMeta{Name: "e"}}
...
func TestProvidersForWorkload(t *testing.T) {
	...
	ag := &kaalmv1beta1.Agent{Spec: kaalmv1beta1.AgentSpec{
		Providers: []kaalmv1beta1.AgentProviderReference{
			{ProviderRef: kaalmv1beta1.LocalObjectReference{Name: "p1"}},
			{ProviderRef: kaalmv1beta1.LocalObjectReference{Name: "p2"}},
		},
	}}
	...
	task := &kaalmv1beta1.AgentTask{Spec: kaalmv1beta1.AgentTaskSpec{
		Providers: []kaalmv1beta1.AgentProviderReference{
			{ProviderRef: kaalmv1beta1.LocalObjectReference{Name: "tp"}},
		},
	}}
...
func TestProvidersForClass(t *testing.T) {
	ctx := context.Background()
	ac := &kaalmv1beta1.AgentClass{Spec: kaalmv1beta1.AgentClassSpec{
		AllowedProviders: []kaalmv1beta1.LocalObjectReference{{Name: "a"}, {Name: "b"}},
	}}
	...
	if reqs := providersForClass(ctx, &kaalmv1beta1.Agent{ObjectMeta: metav1.ObjectMeta{Name: "x"}}); reqs != nil {
