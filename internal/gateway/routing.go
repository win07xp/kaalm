...
func (s *Server) workloadProviders(ctx context.Context, c *caller) ([]kaalmv1beta1.AgentProviderReference, string, bool) {
...
func containsProviderRef(refs []kaalmv1beta1.AgentProviderReference, name string) bool {
	for _, r := range refs {
